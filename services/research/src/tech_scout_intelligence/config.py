...
class Settings(BaseSettings):
    ...
    research_max_seconds: int = Field(default=3600, ge=1, le=7200)
    research_max_requests: int = Field(default=300, ge=1, le=1000)
    research_max_cny: float = Field(default=10, gt=0, le=100)
